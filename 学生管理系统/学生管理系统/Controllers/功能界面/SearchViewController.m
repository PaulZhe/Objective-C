...
- (void)viewDidLoad {
    ...
    [_addButton setTitle:@"查询" forState:normal];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    cell.scoreLable.text = [NSString stringWithFormat:@"%d",_student.score];
        ...
        cell.stuIDLable.text = [NSString stringWithFormat:@"%d",_student2.stuID];
        cell.nameLable.text = _student2.name;
        cell.ageLable.text = [NSString stringWithFormat:@"%d",_student2.age];
        cell.classLable.text = [NSString stringWithFormat:@"%d",_student2.classNum];
        cell.scoreLable.text = [NSString stringWithFormat:@"%d",_student2.score];
    }
    return cell;
}
...
- (void)alert{
    UIAlertController *alertController = [UIAlertController alertControllerWithTitle:@"查询失败" message:@"查询学号不存在或者学号未录入" preferredStyle:UIAlertControllerStyleAlert];
